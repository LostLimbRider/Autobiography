...
AUTOBIOGRAPHY/
  ...
  NONPROFIT/           — Lost Limb Riders: presentation, about, proposal + GOVERNANCE-FRAMEWORK
  TIMELINE/            — life timeline
  PHOTOS/              — photo descriptions + images
Doc/
  Lost_Limb_Riders_Packet/ — pitch deck (PPTX, DOCX), proposal, logo, org infrastructure manuals
